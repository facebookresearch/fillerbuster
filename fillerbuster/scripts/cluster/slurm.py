...
#SBATCH --error=/checkpoint/avatar/%u/tensorboard/sync/fillerbuster/slurm-logs/job.%J.err
#SBATCH --output=/checkpoint/avatar/%u/tensorboard/sync/fillerbuster/slurm-logs/job.%J.out
...
def main(
    ...
    code_path = f"/checkpoint/avatar/ethanjohnweber/tensorboard/sync/fillerbuster/code/{folder_name}/fillerbuster/"
