...
class TrainConfig:
    ...
    output_dir: Optional[str] = "/home/ethanweber/fillerbuster/outputs/tensorboard"
    """Output folder."""
    ...
    mprobs: List[float] = field(default_factory=lambda: [0.5, 0.5])
    """Shutterstock3D, Scannetpp probabilities"""
    ...
    pretrained_clip_path: str = "/home/ethanweber/fillerbuster/checkpoints/clip-vit-large-patch14"
    """Path to the pretrained CLIP model."""
    image_vae_checkpoint: Optional[str] = "/home/ethanweber/fillerbuster/checkpoints/image-vae.ckpt"
    """Path to the pretrained image VAE model."""
    pose_vae_checkpoint: Optional[str] = "/home/ethanweber/fillerbuster/checkpoints/pose-vae.ckpt"
...
class CheckpointsConfig(TrainConfig):
    ...
    checkpoint: Optional[str] = (
        "/home/ethanweber/fillerbuster/outputs/tensorboard/transformer/9710534/checkpoints/checkpoint-step-1425000.ckpt"
    )


@dataclass
class PretrainedCheckpointsConfig(CheckpointsConfig):
    """Main config with DGX checkpoints."""

    checkpoint: Optional[str] = "/home/ethanweber/fillerbuster/checkpoints/transformer.ckpt"
    image_vae_checkpoint: Optional[str] = "/home/ethanweber/fillerbuster/checkpoints/image-vae.ckpt"
    pose_vae_checkpoint: Optional[str] = "/home/ethanweber/fillerbuster/checkpoints/pose-vae.ckpt"
...
BaseMethods = Union[
    ...
    Annotated[PretrainedCheckpointsConfig, tyro.conf.subcommand(name="pretrained-checkpoints")],
